...
type Sensor = {
  ...
  status: string;
  color: string;
  icon: string; // Use string instead of JSX.Element
};
  ...
  export const getServerSideProps = async () => {
    ...
    try {
      ...
      if (login.ok) {
        ...
        //   console.log("Details: ", details[1]['channels'][0]['last_measurement']['display_value']);
        //   const sflowValue = details[1]['channels'][0]['last_measurement']['display_value'] || 0
